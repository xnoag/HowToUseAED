...
struct TurnOnAEDExplain: View {
    let buttonClickSound = Bundle.main.path(forResource: "TurnOn", ofType: "mp3")
                ...
                VStack {
                    ...
                    VStack(alignment: .leading) {
                        Text("Great!")
                            ...
                            .fontWeight(.bold)
                            .padding(.bottom, 10)
                        Text("From the next step,\rplease proceed calmly following the voice instructions.")
                            .font(.title)
                            .fontWeight(.bold)
                    }
                        .frame(width: geo.size.width * 1, height: geo.size.height * 0.3)
                    ...
                    HStack {
                        ...
                        NavigationLink(destination: AttachingPad()) {
                            Text("Next Step")
...
struct TurnOnAEDExplain_Previews: PreviewProvider {
