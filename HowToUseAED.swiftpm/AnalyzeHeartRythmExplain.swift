//
//  AnalyzeHeartRythmExplain.swift
//  HowToUseAED
//
...
struct AnalyzeHeartRythmExplain: View {
                    ...
                    VStack {
                        ...
                        VStack(alignment: .leading) {
                            Text("Great!")
                                ...
                                .fontWeight(.bold)
                                .padding(.bottom, 10)
                            Text("Please step back a little to avoid any errors in the heart analysis.")
                                .font(.title)
                                .fontWeight(.bold)
                        ...
                        HStack {
                            ...
                            NavigationLink(destination: Defibrillation()) {
                                Text("Next Step")
...
struct AnalyzeHeartRythmExplain_Previews: PreviewProvider {
    static var previews: some View {
        AnalyzeHeartRythmExplain()
